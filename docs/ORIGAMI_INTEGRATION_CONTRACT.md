...
Tlaloc `6.0.0-alpha.11` recognizes Origami `6.0.0-alpha.4`. It consumes `origami.relational-core.r0` EXP-001 fixtures through an exact embedded artifact (SHA-256 `363904ae72ed7b9db7d4b371c91ec259e86f3e98bb74e18d2a2b882219c0a5c1`) while Origami retains the executable semantic engine. Contract recognition does not imply perceptual runtime support. `MOIRE`, `PHASE_SHIFT`, `STEREO_BIND`, `PARALLAX_RESOLVE`, `KINETIC_REVEAL`, `TEMPORAL_INTEGRATE`, and `TEMPORAL_DECAY` remain unsupported.
