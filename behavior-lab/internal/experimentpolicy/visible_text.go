...
var synchronousExecutionFidelityVisibleFactsR1 = map[string]string{
	...
	"SYNCHRONOUS_EXECUTION_FIDELITY.STEP2_TEXT": "2 FIRE IF WHEN+TARGET=REQUIRE",
	"SYNCHRONOUS_EXECUTION_FIDELITY.STEP3_TEXT": "3 SELECT ALL FIREABLE",
	"SYNCHRONOUS_EXECUTION_FIDELITY.STEP4_TEXT": "4 APPLY SETS TOGETHER",
	"SYNCHRONOUS_EXECUTION_FIDELITY.NO_ORDER_TEXT": "5 NO ORDER / NO CASCADE",
	"SYNCHRONOUS_EXECUTION_FIDELITY.NEXT_TEXT": "6 NEXT=UPDATED SNAPSHOT",
	"SYNCHRONOUS_EXECUTION_FIDELITY.STOP_TEXT": "7 STOP IF ZERO FIREABLE",
}
